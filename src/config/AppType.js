...
const AppType = {
   ...
   TEST1: { name: 'Test 1', icon: 'Sunny', content: <Weather />, needLoader: false, onMobile:true, appBar: false, width: '450px' },
   TEST2: { name: 'Test 2', icon: 'Sunny', content: <Weather />, needLoader: false, onMobile:true, appBar: false, width: '450px' }
}
